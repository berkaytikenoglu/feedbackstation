...
class AllrequestspageView extends StatelessWidget {
  const AllrequestspageView({super.key});

  @override
  Widget build(BuildContext context) {
    final AllrequestspageController controller =
        Get.put(AllrequestspageController());
    return Scaffold(
