...
class AppInfo {
  ...
  static List<User> appCreators = [
    User(
      id: 1,
      serialNumber: "---TC---",
      firstname: "Berkay",
      lastname: "TİKENOĞLU",
      displayname: "Berkay TİKENOĞLU",
      email: "berkaytikenoglu@gmail.com",
      avatar: Media(
        id: 1,
        type: MediaType.image,
        bigUrl: "assets/images/applogo.png",
        normalUrl: "assets/images/applogo.png",
        minUrl: "assets/images/applogo.png",
        isLocal: true,
      ),
    ),
    User(
      ...
      lastname: "SEVGİ",
      displayname: "öMER Faruk SEVGİ",
      email: "omerfaruksevgi@gmail.com",
      avatar: Media(
        id: 1,
        type: MediaType.image,
        bigUrl: "assets/images/applogo.png",
  ...
  static String appLanguageSupport = "";
  static String appPrivacyPolicy = "";
  static AppKVKK kvkk = AppKVKK(
      title: "KİŞİSEL VERİLERİ KORUMA KURUMU",
      context: '1.GİRİŞ'
          ...
          'Kültür Varlıklarının korunması işlemlerinin yürütülmesi'
          'Kütüphanecilik faaliyetlerinin yürütülmesi'
          'Destek, hibe, teşvik vb. işlemlerin gerçekleştirilmesi'
          'Müzelere ilişkin işlemlerin gerçekleştirilmesi'
          'Avrupa ve dış ilişkilerin yönetilmesi'
          'Basın ve yayın faaliyetlerinin yürütülmesi'
          'Sanatsal etkinlik, faaliyet vb. hususlarda çalışmaların yapılması'
          'Hizmet ve yönetim kalitesinin arttırılması ve bu kapsamda çalışmaların yapılması'
          ...
          'lgili kişinin temek hak ve özgürlüklerine zarar vermemek kaydıyla, veri sorumlusunun meşru menfaatleri için veri işlenmesinin zorunlu olması'
